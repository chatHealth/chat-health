				...
				<form action="../review/ReviewAdd" method="post">
					<div>
						<input type="hidden" name="no" value="${param.no}" /> <input
							class="reviewtitle" type="text" id="retitle" name="retitle"
							placeholder="리뷰 제목" />
						<div class="commetbox">
							<input class="reviewtext" type="text" id="recontent"
								name="recontent" placeholder="리뷰글 작성" />
