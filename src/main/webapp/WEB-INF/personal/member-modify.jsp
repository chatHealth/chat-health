...
<%--					<span class="input-group-text">@</span>--%>
					<input type="email" class="form-control" id="user-email" name="email" value=${member.email }>
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="user-address" name="address" value=${member.address }>
				</div>
				<div class="mb-3">
