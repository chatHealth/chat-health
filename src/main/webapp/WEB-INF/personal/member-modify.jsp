		...
		<div class="col-9 content">
			...
			<form action="../personal/member-modify-process" method="post">
				<div class="mb-3">
					...
					<input type="email" class="form-control" id="email" name="email" value=${loginMember.email }>
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="address" name="address" value=${loginMember.address }>
				</div>
				<div class="mb-3">
					<label for="addressDetail" class="form-label">Address Detail</label>
					<input type="text" class="form-control" id="addressDetail" name="addressDetail" value=${loginMember.addressDetail }>
				</div>
