...
<%@ include file="../include/header-member.jsp"%>
	...
	<form action="../member/member-join-process" method="post" enctype="multipart/form-data">
		<div class="form-join m-auto">
			<h1 class="h3 mb-5 fw-normal text-center fw-semibold" style="color: #347F5C;">🙌개인 회원가입🙌</h1>
			
			<div class="mb-3"><!--닉네임-->
				<div class="d-flex flex-row">
				<label for="nickname" class="form-label">닉네임</label><p style="color: red;">*</p></div>
				<input type="text" class="form-control" id="nickname" name="nickname" required />
			</div>

			<div class="mb-3"><!--이메일-->
				<div class="d-flex flex-row">
				<label for="email" class="form-label">이메일</label><p style="color: red;">*</p></div>
				<input type="email" class="form-control" id="email" name="email" required />
			</div>

			<div class="mb-3"><!--이름-->
				<div class="d-flex flex-row">
				<label for="name" class="form-label">이름</label><p style="color: red;">*</p></div>
				<input type="text" class="form-control" id="name" name="name" required />
			</div>

			<div class="form-check form-check-inline"><!--성별-->	
				<div class="d-flex flex-row">
				<label class="form-label">성별</label><p style="color: red;">*</p></div>
			...
			<div class="mb-3"><!-- 생년월일 -->
				<div class="d-flex flex-row">			
				<label for="birth" class="form-label">생년월일</label><p style="color: red;">*</p></div>
			...
			<div class="row d-flex mt-5 w-100"><!-- 아이디 -->				
					<div class="mb-3">
						<div class="row">
							<div class="col-6">
								<div class="d-flex flex-row">
								<label for="id" class="form-label">아이디</label><p style="color: red;">*</p></div>
			...
			<div class="mb-3"><!--사업장소재지,우편번호찾기 API 연동-->
				<div class="d-flex flex-row">
				<label for="address" class="form-label">주소</label><p style="color: red;">*</p></div>
				<input type="hidden" id="sample4_postcode" placeholder="우편번호">
				<input type="button" class=" btn btn-sm btn-outline-success mb-2" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
			...
			<div class="mb-3">
				...
				<div class="mt-3 form-check">
					...
					<label class="form-check-label w-100 mt-5" for="accepted">(필수)
						<a href="../useAgree.jsp" target="_blank">이용약관</a>과
						<a href="../personal.jsp" target="_blank">개인정보 수집 및 이용</a>에 동의합니다.
					</label>
				</div>
				<button type="submit" class="btn btn-success w-100 my-20" name="">회원가입 신청하기</button>
			</div>
	</form>
